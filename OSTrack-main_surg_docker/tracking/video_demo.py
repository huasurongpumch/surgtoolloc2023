...
def main():
    ...
    parser.add_argument('--videofile', type=str,
                        default='/data1/surgtoolloc/VisualObjectTracking/video_analyst-master/surg_video/clip_005985.mp4',
                        help='path to a video file.')
    parser.add_argument('--optional_box', type=float,
                        default=[702,334,150,153],
